...
public class UserController {
    ...
    public ResponseEntity<String> enrollBookmark(Principal principal, @RequestBody BookmarkRequest request) {
        this.userBookmarkService.enrollBookmark(principal.getName(), request);
        return ResponseEntity.ok("등록 성공");
    }

    @DeleteMapping("/bookmark")
    public ResponseEntity<String> removeBookmark(Principal principal, @RequestBody BookmarkRequest request) {
